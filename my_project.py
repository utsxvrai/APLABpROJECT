...
class bus_booking:
    ...
    def home_page(self):
        ...
        Label(root, image=bus,bg="cyan").grid(row=0, column=1, columnspan=15, padx=w //3, pady=20)
        Label(root, text="Online Bus Booking System", font='Arial 30 bold', bg='bisque', fg='orangered3',relief=RAISED,padx=10,pady=10,bd=5).grid(row=2,
                                                                                                            column=3,
                                                                                                            columnspan=9,
                                                                                                            padx=w // 3)
